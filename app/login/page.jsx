          ...
          <div className="md:w-8/12 lg:w-2/5 lg:ml-20 ">
            ...
            <div className='flex justify-between items-baseline'>
              ...
              <div className='flex flex-row gap-3 items-baseline'>
                ...
                <Link href={'/signup'} className='text-white  hover:text-amber-600 active:text-amber-600 duration-200 transition ease-in-out'>Create account?</Link>
              </div>
            </div>
            {/* Email input */}
            <div className="mb-6">
            ...
            <Link className="px-7 py-3 text-black hover:bg-[#f2f2f2] active:bg-gray-300 bg-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full flex justify-center items-center  mb-3" href="#" role="button">
              {/* Google */}
              <svg className="w-3.5 h-3.5 mr-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            ...
            <Link className="px-7 py-3 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full flex justify-center items-center bg-[#3b5998] hover:bg-[#34518b]" href="#" role="button">
              {/* Facebook */}
