      ...
      <div className="sm:max-w-7xl">
        <div className="sm:flex justify-center items-center text-white">
          ...
          <div className="md:w-8/12 lg:w-2/5 lg:ml-20">
            ...
            <Link className="px-7 py-3 text-black hover:bg-gray-200 active:bg-gray-300 bg-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full flex justify-center items-center  mb-3" href="#" role="button">
              {/* Google */}
