        ...
        <div className='w-full sm:w-1/2 flex flex-col justify-center items-center my-2 space-y-2 self-start '>
          <div className='hidden sm:block '>
            ...
            <div className='w-full flex space-x-4'>
              ...
              <Link href='/preview' className='text-white text-center px-6 py-2 w-1/2 bg-slate-600 rounded-md font-medium tracking-wide text-lg animate-pulse  hover:bg-slate-700 active:bg-slate-800 ease-in-out duration-150 ' >Preview</Link>
              <Link href='/login' className='text-white text-center px-6 py-2 w-1/2 bg-teal-700 rounded-md font-medium tracking-wide text-lg hover:bg-teal-800 active:bg-teal-900 ease-in-out duration-150' >Login</Link>
            </div>

          </div>
          <Link href='/preview' className='sm:hidden text-white text-center px-6 py-2 w-full bg-slate-600 rounded-md font-medium tracking-wide text-lg animate-pulse hover:bg-slate-700 active:bg-slate-800 ease-in-out duration-150' >Preview</Link>
          <Link href='/login' className='sm:hidden text-white text-center px-6 py-2 w-full bg-teal-700 rounded-md font-medium tracking-wide text-lg hover:bg-teal-800 active:bg-teal-900 ease-in-out duration-150' >Login</Link>
        </div>
      </section>
